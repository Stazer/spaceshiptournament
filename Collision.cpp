...
bool Collision::CircleTest(const sf::Sprite& Object1, const sf::Sprite& Object2 , float Radius1 , float Radius2 ) {
    //Simplest circle test possible
    //Distance between points <= sum of radius
 
    Radius1 += (Object1.GetSize().x + Object1.GetSize().y) / 4;
    Radius2 += (Object2.GetSize().x + Object2.GetSize().y) / 4;
...
bool Collision::CircleTest ( sf::Vector2f & Size1 , sf::Vector2f & Position1 , float Radius1 , sf::Vector2f & Size2 , sf::Vector2f & Position2 , float Radius2)
{
    Radius1 += (Size1.x + Size1.y) / 4 ;
    Radius2 += (Size2.x + Size2.y) / 4 ;
