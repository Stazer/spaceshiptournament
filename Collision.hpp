...
public:
     ...
     */
    static bool CircleTest(const sf::Sprite& Object1, const sf::Sprite& Object2,float Radius1 = 0.0f , float Radius2 = 0.0f );
	static bool CircleTest ( sf::Vector2f & Size1 , sf::Vector2f & Position1 , float Radius1 , sf::Vector2f & Size2 , sf::Vector2f & Position2 , float Radius2) ;
